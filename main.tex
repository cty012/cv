...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{\hrefWithoutArrow{mailto:cao\_tianyue@hotmail.com}{cao\_tianyue@hotmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+86-156-0115-3047}{+86 156 0115 3047}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+1-609-250-3145}{+1 (609) 250-3145}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/cty012}{github.com/cty012}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{1010 W University Ave, APT 231-D, Urbana, IL 61801}%
    \end{header}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{University of Illinois at Urbana-Champaign}, BS in Computer Science\end{twocolentry}
